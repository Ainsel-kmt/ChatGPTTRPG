...
router.post('/chat', async (req, res) => {
  ...
  const messages = [
    { role: 'system', content: `次の{}の中の文章を逸脱しないようにゲーム進めてください。
      {プレイヤーがなにか行動や技能を使おうとした際には、ダイスロールをして、その結果と履歴をふまえてシナリオの進行を決めてください
      (この時userにダイスロールを求めないでください)。
      その際に何面のダイスを用いて、出た値、成功値をいくつなのかも教えてください。能力値をつかうダイスロールの場合は1d20を使用してください。
      CON（体力）が0になったらゲームを終了してください。
      戦闘が起きた場合こちらが攻撃した後は必ず相手も攻撃するようにしてください。
      }` },
    ...history,
